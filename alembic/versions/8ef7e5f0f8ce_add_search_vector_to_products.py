...
def upgrade() -> None:
    ...
    #             COALESCE(
    # (SELECT c.name FROM categories c JOIN product_category s ON c.category_id = s.category_id
    ...
    op.execute(
        ...
        SET search_vector = to_tsvector(
            ...
            COALESCE(
                (SELECT c.name
                FROM categories c JOIN product_category s ON c.category_id = s.category_id
